...
{
    [DataContract] 
    public class TypeTabListResponse : IEquatable<TypeTabListResponse>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TypeTabListResponse)obj);
        }

        /// <summary>
        /// Returns true if TypeTabListResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TypeTabListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeTabListResponse other)
        {
